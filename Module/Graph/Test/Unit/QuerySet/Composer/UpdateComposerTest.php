...
EOT;
		...
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\SingleQueryWrapper', $userUpdateQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Update', $userUpdateQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\QueryLinkList', $userUpdateQueryWrapper->getChildLinks());
		...
		$this->assertInstanceof('Sloth\Module\Graph\QuerySet\Face\QueryLinkInterface', $linkToAddressUpdate);
		...
		$this->assertInstanceof('Sloth\Module\Graph\QuerySet\Face\QueryLinkInterface', $linkToPostUpdate);
		...
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\SingleQueryWrapper', $addressUpdateQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Update', $addressUpdateQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\QueryLinkList', $addressUpdateQueryWrapper->getChildLinks());
		...
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\MultiQueryWrapper', $firstPostUpdateQuerySubSet);
		...
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\SingleQueryWrapper', $firstPostUpdateQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Update', $firstPostUpdateQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\QueryLinkList', $firstPostUpdateQueryWrapper->getChildLinks());

		/** @var MultiQueryWrapperInterface $secondPostUpdateQuerySubSet */
		$secondPostUpdateQuerySubSet = $postUpdateQuerySet->getByIndex(1);
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\MultiQueryWrapper', $secondPostUpdateQuerySubSet);
		...
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\SingleQueryWrapper', $secondPostUpdateQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Update', $secondPostUpdateQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\QueryLinkList', $secondPostUpdateQueryWrapper->getChildLinks());
...
EOT;
		...
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\SingleQueryWrapper', $updateUserQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Update', $updateUserQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\QueryLinkList', $updateUserChildLinks);
		...
		$this->assertInstanceof('Sloth\Module\Graph\QuerySet\Face\QueryLinkInterface', $linkToUpdatePostsQuerySet);
		...
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\MultiQueryWrapper', $updatePostsQuerySetWrapper);
		...
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\SingleQueryWrapper', $updateFirstPostQueryWrapper);
		...
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\MultiQueryWrapper', $updateFirstPostCommentsQuerySet);
		...
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\SingleQueryWrapper', $updateFirstCommentQueryWrapper);
		...
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\SingleQueryWrapper', $updateSecondCommentQueryWrapper);
		...
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\SingleQueryWrapper', $updateSecondPostQueryWrapper);
...
EOT;
		...
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\SingleQueryWrapper', $updateUserQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Update', $updateUserQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\QueryLinkList', $updateUserQueryWrapper->getChildLinks());
		...
		$this->assertInstanceof('Sloth\Module\Graph\QuerySet\Face\QueryLinkInterface', $linkToUpdateFriendsQuerySet);
		...
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\SingleQueryWrapper', $updateFirstFriendQueryWrapper);
		...
		$this->assertInstanceOf('Sloth\Module\Graph\QuerySet\QueryWrapper\SingleQueryWrapper', $updateSecondFriendQueryWrapper);
