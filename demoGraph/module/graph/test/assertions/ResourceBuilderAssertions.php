...
trait ResourceBuilderAssertions
{
	public function assertBuiltResourceMatchesUserManifest(Definition\Table $resource)
	{
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\AttributeList', $resource->attributes);
		$this->assertEquals(3, $resource->attributes->length());
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\LinkList', $resource->links);
		$this->assertEquals(3, $resource->links->length());
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\ValidatorList', $resource->validators);
		$this->assertEquals(0, $resource->validators->length());
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\ViewList', $resource->views);
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\TableField', $resource->attributes->getByIndex(0)->field);
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\ValidatorList', $resource->attributes->getByIndex(0)->validators);
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\TableField', $resource->attributes->getByIndex(1)->field);
		$this->assertSame($resource->table, $resource->attributes->getByIndex(1)->field->resource);
		$this->assertEquals('forename', $resource->attributes->getByIndex(1)->field->name);
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\ValidatorList', $resource->attributes->getByIndex(1)->validators);
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\TableField', $resource->attributes->getByIndex(2)->field);
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\ValidatorList', $resource->attributes->getByIndex(2)->validators);
	...
	public function assertBuiltUserResourceLinksToFriendsSubResource(Definition\Table $resource)
	{
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\TableList', $linkToFriends->intermediaryTables);
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\LinkConstraintList', $linkToFriends->getConstraints());
		$this->assertEquals(1, $linkToFriends->getConstraints()->length());

		$joinToFriends = $linkToFriends->getConstraints()->getByIndex(0);
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\LinkConstraint', $joinToFriends);
		$this->assertSame($linkToFriends, $joinToFriends->link);
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\Attribute', $joinToFriends->parentAttribute);
		$this->assertEquals('id', $joinToFriends->parentAttribute->name);
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\Attribute', $joinToFriends->childAttribute);
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\TableJoinList', $subJoinsToFriends);
		$this->assertEquals(2, $subJoinsToFriends->length());

		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\TableJoin', $subJoinsToFriends->getByIndex(0));
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\Table', $subJoinsToFriends->getByIndex(0)->childTable);
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\TableField', $subJoinsToFriends->getByIndex(0)->childAttribute);
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\TableJoin', $subJoinsToFriends->getByIndex(1));
		$this->assertSame($subJoinsToFriends->getByIndex(0)->childTable, $subJoinsToFriends->getByIndex(1)->parentTable);

		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\TableField', $subJoinsToFriends->getByIndex(1)->parentAttribute);
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\Table', $subJoinsToFriends->getByIndex(1)->childTable);
	...
	public function assertBuiltUserResourceLinksToPostsSubResource(Definition\Table $resource)
	{
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\Link', $linkToPosts);
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\LinkConstraintList', $linkToPosts->getConstraints());
		$this->assertEquals(1, $linkToPosts->getConstraints()->length());

		$joinToPosts = $linkToPosts->getConstraints()->getByIndex(0);
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\LinkConstraint', $joinToPosts);
		$this->assertSame($linkToPosts, $joinToPosts->link);
		$this->assertNull($joinToPosts->subJoins);

		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\Attribute', $joinToPosts->parentAttribute);
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\TableField', $joinToPosts->childAttribute->field);
		$this->assertEquals('authorId', $joinToPosts->childAttribute->field->name);
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\Table', $joinToPosts->childAttribute->table);
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\ValidatorList', $joinToPosts->childAttribute->validators);
	...
	public function assertBuiltUserResourceLinksToAddressSubResource(Definition\Table $resource)
	{
        ...
        $this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\Link', $linkToAddress);
        ...
        $this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\LinkConstraintList', $linkToAddress->getConstraints());
        $this->assertEquals(1, $linkToAddress->getConstraints()->length());

        $joinToAddress = $linkToAddress->getConstraints()->getByIndex(0);
        $this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\LinkConstraint', $joinToAddress);
        $this->assertSame($linkToAddress, $joinToAddress->link);
        $this->assertNull($joinToAddress->subJoins);

        $this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\Attribute', $joinToAddress->parentAttribute);
        ...
        $this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\TableField', $joinToAddress->childAttribute->field);
        $this->assertEquals('userId', $joinToAddress->childAttribute->field->name);
        $this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\Table', $joinToAddress->childAttribute->table);
        ...
        $this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\ValidatorList', $joinToAddress->childAttribute->validators);
	...
	public function assertBuiltResourceMatchesPostManifest(Definition\Table $resource)
	{
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\Table', $resource->table);
		...
		$this->assertSame($resource, $resource->attributes->getByIndex(0)->table);
		...
		$this->assertSame($resource, $resource->attributes->getByIndex(1)->table);
		$this->assertSame($resource->table, $resource->attributes->getByIndex(2)->table);
		...
		$this->assertSame($resource, $resource->attributes->getByIndex(2)->table);
		$this->assertSame($resource->table, $resource->attributes->getByIndex(2)->table);
	...
	public function assertBuiltPostResourceLinksToAuthorSubResource(Definition\Table $resource)
	{
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\LinkConstraintList', $linkToAuthor->getConstraints());
		$this->assertEquals(1, $linkToAuthor->getConstraints()->length());

		$joinToAuthor = $linkToAuthor->getConstraints()->getByIndex(0);
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\LinkConstraint', $joinToAuthor);
		$this->assertSame($linkToAuthor, $joinToAuthor->link);
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\Attribute', $joinToAuthor->parentAttribute);
		$this->assertEquals('authorId', $joinToAuthor->parentAttribute->name);
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\Attribute', $joinToAuthor->childAttribute);
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\Table', $joinToAuthor->childAttribute->table);
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\TableField', $joinToAuthor->childAttribute->field);
		...
		$this->assertInstanceOf('DemoGraph\Module\Graph\TableDefinition\ValidatorList', $joinToAuthor->childAttribute->validators);
