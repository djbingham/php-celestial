<?php
namespace Sloth\Module\DataTableQuery\Test\Unit\QuerySet\Composer;
...
EOT;
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\MultiQueryWrapper', $querySet);
		$this->assertEquals(1, $querySet->length());

		/** @var SingleQueryWrapperInterface $queryWrapper */
		$queryWrapper = $querySet->getByIndex(0);
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $queryWrapper);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\QueryLinkList', $queryWrapper->getChildLinks());
...
EOT;
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $firstQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Insert', $firstQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\QueryLinkList', $firstQueryWrapper->getChildLinks());
		...
		$this->assertInstanceof('Sloth\Module\DataTableQuery\QuerySet\Face\QueryLinkInterface', $firstChildLink);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $secondQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Insert', $secondQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\QueryLinkList', $secondQueryWrapper->getChildLinks());
...
EOT;
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\MultiQueryWrapper', $firstQuerySet);
		...
		/** @var QueryLinkInterface $firstChildLink */
		$firstChildLink = $firstQueryWrapper->getChildLinks()->getByIndex(0);
		$this->assertInstanceof('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\QueryLink', $firstChildLink);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\MultiQueryWrapper', $secondQuerySetFirstSubset);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\MultiQueryWrapper', $secondQuerySetSecondSubset);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $thirdQueryWrapper);
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\QueryLinkList', $thirdQueryWrapper->getChildLinks());
...
EOT;
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $userInsertQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Insert', $userInsertQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\QueryLinkList', $userInsertQueryWrapper->getChildLinks());
		...
		$this->assertInstanceof('Sloth\Module\DataTableQuery\QuerySet\Face\QueryLinkInterface', $linkToAddressInsert);
		...
		$this->assertInstanceof('Sloth\Module\DataTableQuery\QuerySet\Face\QueryLinkInterface', $linkToPostInsert);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $addressInsertQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Insert', $addressInsertQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\QueryLinkList', $addressInsertQueryWrapper->getChildLinks());
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\MultiQueryWrapper', $firstPostInsertQuerySubSet);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $firstPostInsertQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Insert', $firstPostInsertQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\QueryLinkList', $firstPostInsertQueryWrapper->getChildLinks());

		/** @var MultiQueryWrapperInterface $secondPostInsertQuerySubSet */
		$secondPostInsertQuerySubSet = $postInsertQuerySet->getByIndex(1);
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\MultiQueryWrapper', $secondPostInsertQuerySubSet);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $secondPostInsertQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Insert', $secondPostInsertQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\QueryLinkList', $secondPostInsertQueryWrapper->getChildLinks());
...
EOT;
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $insertUserQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Insert', $insertUserQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\QueryLinkList', $insertUserQueryWrapper->getChildLinks());
		...
		$this->assertInstanceof('Sloth\Module\DataTableQuery\QuerySet\Face\QueryLinkInterface', $linkToInsertFriendsQuerySet);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $insertFirstFriendQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Insert', $insertFirstFriendQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\QueryLinkList', $insertFirstFriendQueryWrapper->getChildLinks());
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $insertSecondFriendQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Insert', $insertSecondFriendQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\QueryLinkList', $insertSecondFriendQueryWrapper->getChildLinks());
...
EOT;
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $insertUserQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Insert', $insertUserQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\QueryLinkList', $insertUserChildLinks);
		$this->assertSame($table, $insertUserQueryWrapper->getTable());
		...
		$this->assertInstanceof('Sloth\Module\DataTableQuery\QuerySet\Face\QueryLinkInterface', $linkToInsertPostsQuerySet);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\MultiQueryWrapper', $insertPostsQuerySetWrapper);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\MultiQueryWrapper', $firstPostQuerySubset);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $insertFirstPostQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Insert', $insertFirstPostQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\QueryLinkList', $firstPostChildLinks);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\MultiQueryWrapper', $insertFirstPostCommentsQuerySet);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\MultiQueryWrapper', $firstCommentOnFirstPostQuerySubSet);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $insertFirstCommentQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Insert', $insertFirstCommentQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\QueryLinkList', $firstCommentChildLinks);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\MultiQueryWrapper', $secondCommentOnFirstPostQuerySubSet);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $insertSecondCommentQueryWrapper);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\QueryLinkList', $secondCommentChildLinks);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\MultiQueryWrapper', $secondPostQuerySubSet);
		...
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $insertSecondPostQueryWrapper);
		$this->assertInstanceOf('SlothMySql\QueryBuilder\Query\Insert', $insertSecondPostQueryWrapper->getQuery());
		$this->assertInstanceOf('Sloth\Module\DataTableQuery\QuerySet\QueryWrapper\QueryLinkList', $secondPostChildLinks);
