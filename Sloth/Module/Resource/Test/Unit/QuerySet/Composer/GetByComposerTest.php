...
use Sloth\Module\Resource\QuerySet\Composer\GetByComposer;
use Sloth\Module\Resource\QuerySet\Filter\FilterParser;
...
EOT;
		...
		$this->assertInstanceOf('Sloth\Module\Resource\QuerySet\Face\MultiQueryWrapperInterface', $querySet);
		$this->assertEquals(1, $querySet->length());

		/** @var SingleQueryWrapperInterface $queryWrapper */
		$queryWrapper = $querySet->getByIndex(0);
		$this->assertInstanceOf('Sloth\Module\Resource\QuerySet\Face\SingleQueryWrapperInterface', $queryWrapper);
		...
		$this->assertInstanceOf('Sloth\Module\Resource\QuerySet\Face\QueryLinkListInterface', $queryWrapper->getChildLinks());
...
EOT;
		...
		$this->assertInstanceOf('Sloth\Module\Resource\QuerySet\Face\SingleQueryWrapperInterface', $userQueryWrapper);
		$this->assertSame($table, $userQueryWrapper->getTable());

		$userLinks = $userQueryWrapper->getChildLinks();
		$this->assertInstanceOf('Sloth\Module\Resource\QuerySet\Face\QueryLinkListInterface', $userLinks);
		...
		$this->assertInstanceOf('Sloth\Module\Resource\QuerySet\Face\SingleQueryWrapperInterface', $postQueryWrapper);
		...
		$this->assertInstanceOf('Sloth\Module\Resource\QuerySet\Face\QueryLinkListInterface', $postLinks);
...
EOT;
		...
		$this->assertInstanceOf('Sloth\Module\Resource\QuerySet\Face\SingleQueryWrapperInterface', $postAndAuthorQueryWrapper);
		...
		$this->assertInstanceOf('Sloth\Module\Resource\QuerySet\Face\QueryLinkListInterface', $postAndAuthorLinks);
		...
		$this->assertInstanceOf('Sloth\Module\Resource\QuerySet\Face\SingleQueryWrapperInterface', $authorPostQueryWrapper);
		...
		$this->assertInstanceOf('Sloth\Module\Resource\QuerySet\Face\QueryLinkListInterface', $authorPostLinks);
...
EOT;
		...
		$this->assertInstanceOf('Sloth\Module\Resource\QuerySet\Face\SingleQueryWrapperInterface', $friendQueryWrapper);
		...
		$this->assertInstanceOf('Sloth\Module\Resource\QuerySet\Face\QueryLinkListInterface', $friendLinks);
...
EOT;
		...
		$this->assertInstanceOf('Sloth\Module\Resource\QuerySet\Face\SingleQueryWrapperInterface', $friendOfFriendQueryWrapper);
		...
		$this->assertInstanceOf('Sloth\Module\Resource\QuerySet\Face\QueryLinkListInterface', $friendOfFriendLinks);
