...
namespace Celestial\Module\Data\TableValidation\Test;
...
abstract class UnitTest extends \PHPUnit_Framework_TestCase
{
	...
	{
		return $this->getMockBuilder('Celestial\\Module\\Data\\TableValidation\\DependencyManager')
	...
	{
		return $this->getMockBuilder('Celestial\\Module\\Validation\\ValidationModule')
			->disableOriginalConstructor()
			->getMock();
	}
	...
	{
		return $this->getMockBuilder('Celestial\\Module\\Validation\\Result\\ValidationResult')
			->disableOriginalConstructor()
			->getMock();
	}
	...
	{
		return $this->getMockBuilder('Celestial\\Module\\Validation\\Result\\ValidationResultList')
			->disableOriginalConstructor()
			->getMock();
	}
	...
	{
		return $this->getMockBuilder('Celestial\\Module\\Validation\\Result\\ValidationError')
			->disableOriginalConstructor()
			->getMock();
	}
	...
	{
		return $this->getMockBuilder('Celestial\\Module\\Validation\\Result\\ValidationErrorList')
			->disableOriginalConstructor()
			->getMock();
	}
