	...
	foreach ($attributes as $attribute) {
		if (array_key_exists($attribute->name, $data)) {
			if ($attribute instanceof AttributeList) {
				...
				if (!in_array($childLink->onUpdate, array(Celestial\Module\Data\Table\Definition\Table\Join::ACTION_IGNORE, Celestial\Module\Data\Table\Definition\Table\Join::ACTION_REJECT))) {
