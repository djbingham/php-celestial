...
use Celestial\Module\Data\TableValidation\Validator\Join\Property\ViaValidator;
...
class ViaValidatorTest extends UnitTest
{
	...
	private function mockViaPropertyValidator($propertyName)
	{
		...
		$className = 'Celestial\\Module\\Data\\TableValidation\\Validator\\Join\\Property\\Via\\' . $className;
