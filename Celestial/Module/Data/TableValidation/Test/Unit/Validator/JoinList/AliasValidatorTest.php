...
use Celestial\Module\Data\TableValidation\Validator\JoinList\AliasValidator;
...
class AliasValidatorTest extends UnitTest
{
	...
	public function testValueMustNotBeArray()
	{
		...
		$this->setupMockExpectationsForSingleError($validator, $validationResult, 'Join alias must be a string');
	...
	public function testValueMayBeString()
	{
		...
		$result = $validator->validate('joinName');
