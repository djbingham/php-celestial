...
use DemoGraph\Module\Graph\Definition\Attribute;
use DemoGraph\Module\Graph\Definition\AttributeList;
use DemoGraph\Module\Graph\Definition\Table;
use DemoGraph\Module\Graph\Definition\TableLink;
...
class AttributeMapper
{
    ...
    public function __construct(ResourceDefinition\Resource $resourceDefinition)
    {
    ...
    public function mapTablesToAttributes()
    {
        if (!array_key_exists('mapTablesToAttributes', $this->cache)) {
            $attributeList = $this->resourceDefinition->attributes;
