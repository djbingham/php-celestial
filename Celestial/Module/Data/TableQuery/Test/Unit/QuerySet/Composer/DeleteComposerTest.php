...
use Celestial\Module\Data\TableQuery\QuerySet\Composer\DeleteComposer;
...
EOT;
	...
	public function testQuerySetRejectedIfOneToOneLinkSetToAssociateOnDelete()
	{
		...
		$this->setExpectedException('Celestial\Exception\InvalidRequestException', 'On delete action should not be "associate" for a join that is not many-to-many: User_address');
		$composer->compose();
	}
...
EOT;
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $userDeleteQueryWrapper);
		$this->assertInstanceOf('PhpMySql\QueryBuilder\Query\Delete', $userDeleteQueryWrapper->getQuery());
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\QueryLinkList', $userDeleteQueryWrapper->getChildLinks());
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $addressDeleteQueryWrapper);
		$this->assertInstanceOf('PhpMySql\QueryBuilder\Query\Delete', $addressDeleteQueryWrapper->getQuery());
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\QueryLinkList', $addressDeleteQueryWrapper->getChildLinks());

		/** @var SingleQueryWrapperInterface $postDeleteQueryWrapper */
		$postDeleteQueryWrapper = $querySet->getByIndex(2);
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $postDeleteQueryWrapper);
		$this->assertInstanceOf('PhpMySql\QueryBuilder\Query\Delete', $postDeleteQueryWrapper->getQuery());
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\QueryLinkList', $postDeleteQueryWrapper->getChildLinks());
...
EOT;
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $deletePostsQueryWrapper);
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\QueryLinkList', $deletePostsChildLinks);
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $deleteCommentsQueryWrapper);
		$this->assertInstanceOf('PhpMySql\QueryBuilder\Query\Delete', $deleteCommentsQueryWrapper->getQuery());
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\QueryLinkList', $deleteCommentsChildLinks);
...
EOT;
		...
		/** @var SingleQueryWrapperInterface $deleteUserQueryWrapper */
		$deleteUserQueryWrapper = $querySet->getByIndex(0);
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $deleteUserQueryWrapper);
		$this->assertInstanceOf('PhpMySql\QueryBuilder\Query\Delete', $deleteUserQueryWrapper->getQuery());
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\QueryLinkList', $deleteUserQueryWrapper->getChildLinks());
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $deleteFriendsQueryWrapper);
