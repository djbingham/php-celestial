<?php
namespace Celestial\Module\Data\TableValidation\Test\Unit\Validator\Join;

use Celestial\Module\Data\TableValidation\Base\BaseValidator;
use Celestial\Module\Data\TableValidation\Test\UnitTest;
use Celestial\Module\Data\TableValidation\Validator\Join\JoinValidator;
...
class JoinValidatorTest extends UnitTest
{
	...
	public function testValidateThrowsExceptionIfOptionsValidationFails()
	{
		...
		$this->setExpectedException('Celestial\Exception\InvalidArgumentException', 'Invalid options given to join validator');
	...
	private function mockPropertyValidator($propertyName)
	{
		...
		$className = 'Celestial\\Module\\Data\\TableValidation\\Validator\\Join\\Property\\' . $className;
	...
	{
		$className = 'Celestial\\Module\\Data\\TableValidation\\Validator\\Join\\StructureValidator';
