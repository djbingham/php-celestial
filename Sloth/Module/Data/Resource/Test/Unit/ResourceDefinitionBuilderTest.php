<?php
namespace Sloth\Module\Data\Resource\Test\Unit;
...
class ResourceDefinitionBuilderTest extends UnitTest
{
	...
	{
		return $this->getMockBuilder('Sloth\Module\Data\Resource\ResourceManifestValidator')
			->disableOriginalConstructor()
			->getMock();
	}
	...
	{
		return $this->getMockBuilder('Sloth\Module\Data\Resource\DefinitionBuilder\ValidatorListBuilder')
			->disableOriginalConstructor()
			->getMock();
	}
	...
	{
		return $this->getMockBuilder('Sloth\Module\Data\Resource\DefinitionBuilder\AttributeListBuilder')
			->disableOriginalConstructor()
			->getMock();
	}
	...
	{
		return $this->getMockBuilder('Sloth\Module\Data\Table\Definition\Table')
			->disableOriginalConstructor()
			->getMock();
	}
