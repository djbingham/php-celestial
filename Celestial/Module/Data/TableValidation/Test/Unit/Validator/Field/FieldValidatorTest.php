<?php
namespace Celestial\Module\Data\TableValidation\Test\Unit\Validator\Field;

use Celestial\Module\Data\TableValidation\Base\BaseValidator;
use Celestial\Module\Data\TableValidation\Validator\Field\FieldValidator;
...
class FieldValidatorTest extends UnitTest
{
	...
	private function mockPropertyValidator($propertyName)
	{
		...
		$className = 'Celestial\\Module\\Data\\TableValidation\\Validator\\Field\\Property\\' . $className;
	...
	{
		$className = 'Celestial\\Module\\Data\\TableValidation\\Validator\\Field\\StructureValidator';
