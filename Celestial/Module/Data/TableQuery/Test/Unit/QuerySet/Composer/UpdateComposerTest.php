...
EOT;
	...
	public function testExceptionIsThrownIfOneToOneLinkSetToAssociateOnUpdate()
	{
		...
		$this->setExpectedException('Celestial\Exception\InvalidRequestException', 'On update action should not be "associate" for a join that is not many-to-many: User_address');
		$composer->compose();
	}
...
EOT;
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $userUpdateQueryWrapper);
		$this->assertInstanceOf('PhpMySql\QueryBuilder\Query\Update', $userUpdateQueryWrapper->getQuery());
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\QueryLinkList', $userUpdateQueryWrapper->getChildLinks());
		...
		$this->assertInstanceof('Celestial\Module\Data\TableQuery\QuerySet\Face\QueryLinkInterface', $linkToAddressUpdate);
		...
		$this->assertInstanceof('Celestial\Module\Data\TableQuery\QuerySet\Face\QueryLinkInterface', $linkToPostUpdate);
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $addressUpdateQueryWrapper);
		$this->assertInstanceOf('PhpMySql\QueryBuilder\Query\Update', $addressUpdateQueryWrapper->getQuery());
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\QueryLinkList', $addressUpdateQueryWrapper->getChildLinks());
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\MultiQueryWrapper', $firstPostUpdateQuerySubSet);
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $firstPostUpdateQueryWrapper);
		$this->assertInstanceOf('PhpMySql\QueryBuilder\Query\Update', $firstPostUpdateQueryWrapper->getQuery());
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\QueryLinkList', $firstPostUpdateQueryWrapper->getChildLinks());

		/** @var MultiQueryWrapperInterface $secondPostUpdateQuerySubSet */
		$secondPostUpdateQuerySubSet = $postUpdateQuerySet->getByIndex(1);
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\MultiQueryWrapper', $secondPostUpdateQuerySubSet);
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $secondPostUpdateQueryWrapper);
		$this->assertInstanceOf('PhpMySql\QueryBuilder\Query\Update', $secondPostUpdateQueryWrapper->getQuery());
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\QueryLinkList', $secondPostUpdateQueryWrapper->getChildLinks());
...
EOT;
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $updateUserQueryWrapper);
		$this->assertInstanceOf('PhpMySql\QueryBuilder\Query\Update', $updateUserQueryWrapper->getQuery());
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\QueryLinkList', $updateUserChildLinks);
		...
		$this->assertInstanceof('Celestial\Module\Data\TableQuery\QuerySet\Face\QueryLinkInterface', $linkToUpdatePostsQuerySet);
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\MultiQueryWrapper', $updatePostsQuerySetWrapper);
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $updateFirstPostQueryWrapper);
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\MultiQueryWrapper', $updateFirstPostCommentsQuerySet);
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $updateFirstCommentQueryWrapper);
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $updateSecondCommentQueryWrapper);
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $updateSecondPostQueryWrapper);
...
EOT;
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $updateUserQueryWrapper);
		$this->assertInstanceOf('PhpMySql\QueryBuilder\Query\Update', $updateUserQueryWrapper->getQuery());
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\QueryLinkList', $updateUserQueryWrapper->getChildLinks());
		...
		$this->assertInstanceof('Celestial\Module\Data\TableQuery\QuerySet\Face\QueryLinkInterface', $linkToUpdateFriendsQuerySet);
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $updateFirstFriendQueryWrapper);
		...
		$this->assertInstanceOf('Celestial\Module\Data\TableQuery\QuerySet\QueryWrapper\SingleQueryWrapper', $updateSecondFriendQueryWrapper);
