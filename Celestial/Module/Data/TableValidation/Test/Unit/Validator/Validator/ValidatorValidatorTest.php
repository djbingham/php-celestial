...
namespace Celestial\Module\Data\TableValidation\Test\Unit\Validator\Validator;

use Celestial\Module\Data\TableValidation\Base\BaseValidator;
use Celestial\Module\Data\TableValidation\Test\UnitTest;
use Celestial\Module\Data\TableValidation\Validator\Validator\ValidatorValidator;
...
class ValidatorValidatorTest extends UnitTest
{
	...
	private function mockPropertyValidator($propertyName)
	{
		...
		$className = 'Celestial\\Module\\Data\\TableValidation\\Validator\\Validator\\Property\\' . $className;
	...
	{
		$className = 'Celestial\\Module\\Data\\TableValidation\\Validator\\Validator\\StructureValidator';
